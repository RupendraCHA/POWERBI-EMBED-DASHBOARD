...
//       try {
//         const response = await axios.get("http://localhost:5000/get-embed-token");
...
//       <div
//         ref={reportRef}
//         style={{ height: "90vh", width: "100vw", border: "1px solid #ccc" }}
//       ></div>
//     </div>
//   );
// };
...
const PowerBIReport = () => {
  ...
  const fetchEmbedToken = async (id, groupID, reportID) => {
